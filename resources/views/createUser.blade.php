    ...
    <style>
        ...
        *,
        ...
        .submit-btn:hover {
            ...
            box-shadow: 0 8px 20px rgba(255, 45, 32, 0.4);
        }
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8 bg-red-500">
            ...
            <div class="form-container" style="margin-top: 50px;">
                <h2 style="color:#555 !important; font-weight: 800; font-size:18pt;">Criar Novo Usuário</h2>
                <form id="createUserForm">
                    <div class="form-group">
                        <label for="name">Nome</label>
                        <input type="text" name="name" id="name" required>
                        <div id="error-name" style="color: #FF2D20; font-size: 0.9em; margin-top: 0.2em;"></div>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" name="email" id="email" required>
                        <div id="error-email" style="color: #FF2D20; font-size: 0.9em; margin-top: 0.2em;"></div>
                    </div>
                    <div class="form-group">
                        <label for="password">Senha</label>
                        <input type="password" name="password" id="password" required>
                        <div id="error-password" style="color: #FF2D20; font-size: 0.9em; margin-top: 0.2em;"></div>
                    </div>
                    <button type="button" class="submit-btn" onclick="sendUserData()">Criar Usuário</button>
                </form>
            </div>
        </div>
    </div>
